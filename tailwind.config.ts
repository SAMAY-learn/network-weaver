...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-cyber": "linear-gradient(135deg, hsl(var(--cyber-blue)), hsl(var(--cyber-cyan)))",
        "gradient-threat": "linear-gradient(135deg, hsl(var(--threat-high)), hsl(var(--threat-medium)))",
      ...
      boxShadow: {
        ...
        "glow-threat": "0 0 20px hsl(var(--threat-high) / 0.4)",
      },
    },
  },
